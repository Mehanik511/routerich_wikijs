...
description: 
published: true
date: 2025-01-10T14:51:45.519Z
tags: 
editor: markdown
dateCreated: 2025-01-10T05:56:38.646Z
---

Переходим по ссылке: http://routerich.lan/cgi-bin/luci/admin/network/wireless
Или идём в "**Сеть → Беспроводная сеть**"
...
- **Разрешить все, кроме перечисленных:** Этот режим работает наоборот: доступ к сети будет разрешён всем устройствам, кроме тех, чьи MAC-адреса указаны в списке. То есть, устройства, находящиеся в чёрном списке, будут заблокированы.
   - **Пример настройки**: 
